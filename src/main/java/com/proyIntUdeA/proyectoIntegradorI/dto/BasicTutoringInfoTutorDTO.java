...
public class BasicTutoringInfoTutorDTO {
    ...
    public BasicTutoringInfoTutorDTO(Long classId, Date classDate, String subjectName, boolean registered, canceledBy canceledBy, String classTopics, String studentId, String studentName, String studentLastname) {
